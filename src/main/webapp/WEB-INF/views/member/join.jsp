				...
				<div class="col-xs-8" style="margin:0 auto; float: none;">
					...
					<form action="/member/join" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="memberId" id="memberId" placeholder="e-mail을 입력하세요">
							</div>
							<div class="col-xs-3">
								<input type="button" onclick="CheckId" value="인증하기" class="btn btn-primary">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="memberName" id="memberName" placeholder="성함을 입력해주세요">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="memberNick" id="memberNick" placeholder="닉네임을 입력해주세요">
							</div>
							<div class="col-xs-3">
								<input type="button" onclick="CheckNick" value="중복확인" class="btn btn-primary">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="password" class="form-control" name="memberPw" id="memberPw" placeholder="영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8-16자">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="password" class="form-control" name="memberPwChk" id="memberPwChk">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" style="cursor: pointer;" class="form-control" id="testDatepicker" name="memberBirth" readonly="readonly">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" class="form-control" name="memberTel" id="memberTel" placeholder="(-)없이 입력해주세요">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-3">
								<input type="text" id="postCode" placeholder="우편번호" name="postCode" class="form-control">
							</div>
							<div class="col-xs-3">
						...
						<div class="form-group">
							...
							<div class="col-xs-2">
								<label><input type="radio" name="memberGender" value="female" checked="checked"/> 여성</label>
							</div>
							<div class="col-xs-2">
								<label><input type="radio" name="memberGender" value="male" /> 남성</label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 text-left">
						        ...
						        <label><input type="checkbox" name="genre" value="6" />로맨스 판타지</label>&nbsp;
							</div>
						</div>
...
<!-- 							</div> -->
						...
						<div class="form-group">
							...
							<div class="col-xs-2">
								<label><input type="radio" name="subcheck" value="y" /> 구독</label>
							</div>
							<div class="col-xs-3">
								<label><input type="radio" name="subcheck" value="n" checked="checked" /> 구독 안함</label>
							</div>
<!-- 							<div class="col-xs-6"> -->
...
<!-- 							</div> -->
						...
						<div class="form-group">
							<div class="text-center">
								<label><input type="checkbox" name="termsofuse" value="이용약관" />이용약관 및 개인정보수집 및 이용, 마케팅 수신(선택)에 모두 동의합니다.</label>
							</div>
						</div>
