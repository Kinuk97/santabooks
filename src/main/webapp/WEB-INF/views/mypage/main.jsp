...
<div id = "info_genre">
	...
	<a href="/mypage/deletePwChk"><button id="memberDrawal" class="btn btn-danger btn-sm">회원탈퇴</button></a>
	<a href="/mypage/qnaList?memberNo=${info.memberNo }"><button id="qna" class="btn btn-primary btn-sm">1:1문의</button></a>
</div>
